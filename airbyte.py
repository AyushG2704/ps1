...
AIRBYTE_WORKSPACE_ID = "5ae6b09b-fdec-41af-aaf7-7d94cfc33efc"
...
POSTGRES_SCHEMA = COCKROACHDB_SCHEMA = "schema"
...
class CliffAirbyte:
    ...
    def get_destination_configuration():
        destination_configuration = {"password": "Ayush@1089",
                                     "username": "AYUSH", "schema": "public",
                                     "database": "PS",
                                     "host": "mu42710.ap-south-1.aws.snowflakecomputing.com",
                                     "warehouse": "COMPUTE_WH",
                                     "role": "SYSADMIN"}
                                    
        # destination_configuration = {"basic_normalization": True, "ssl": False, "password": COCKROACHDB_PASSWORD,
        #                              "username": COCKROACHDB_USER, "schema": COCKROACHDB_SCHEMA,
        #                              "database": COCKROACHDB_DATABASE, "port": COCKROACHDB_PORT,
...
if __name__ == "__main__":
    cliff_airbyte_obj = CliffAirbyte("60e6c20ab559230c5f324dc1")
